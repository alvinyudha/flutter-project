...
<head>
    ...
    <meta property="og:description"
        content="Vali is a responsive and free admin theme built with Bootstrap 4, SASS and PUG.js. It's fully customizable and modular.">
    <title>@yield('title') | Cuti APPS</title>
    <meta charset="utf-8">
...
<body class="app sidebar-mini rtl">
    ...
    <aside class="app-sidebar">
        <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="{{ asset('img/pegawai.png') }}"
        ...
        <ul class="app-menu">
            ...
            <li class="treeview {{ request()->is('agama', 'negara', 'darah', 'keluarga') ? 'is-expanded' : '' }}">
                <a class="app-menu__item" href="#" data-toggle="treeview">
                    <i class="app-menu__icon fa fa-edit"></i><span class="app-menu__label">Tambah Data</span>
                    <i class="treeview-indicator fa fa-angle-right"></i>
                </a>
                <ul class="treeview-menu">
                    <li><a class="treeview-item {{ request()->is('agama') ? 'active' : '' }}"
                            href="{{ route('agama.index') }}"><i class="icon fa fa-circle-o"></i> Agama</a></li>
                    <li><a class="treeview-item {{ request()->is('negara') ? 'active' : '' }}"
                            href="{{ route('negara.index') }}"><i class="icon fa fa-circle-o"></i> Kewarganegaraan</a>
                    </li>
