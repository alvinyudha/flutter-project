...
<head>
    ...
    <!-- Favicons -->
    <link href="{{ asset('nice/assets/img/favicon.png') }}s" rel="icon">
    <link href="{{ asset('nice/assets/img/apple-touch-icon.png') }}s" rel="apple-touch-icon">
...
<body>
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
            &copy; Copyright <strong><span>CutiApps</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
